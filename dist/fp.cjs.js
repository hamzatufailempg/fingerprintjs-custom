...
function loadSources(sources, sourceOptions, excludeSources) {
    var includedSources = Object.keys(sources).filter(function (sourceKey) { return excludes(tslib.__spreadArray(["audio", "hdr", "canvas", "colorDepth", "forcedColors", "touchSupport", "pdfViewerEnabled", "fonts", "domBlockers", "fontPreferences", "screenFrame", "screenResolution", "hardwareConcurrency", "plugins", "vendor", "vendorFlavors", "cookiesEnabled", "colorGamut", "monochrome", "reducedMotion", "reducedTransparency", "applePay", "privateClickMeasurement", "webGlBasics", "webGlExtensions"], excludeSources, true), sourceKey); });
