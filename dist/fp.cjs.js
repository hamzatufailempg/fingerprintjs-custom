...
function loadSources(sources, sourceOptions, excludeSources) {
    var includedSources = Object.keys(sources).filter(function (sourceKey) { return excludes(tslib.__spreadArray(["touchSupport", "pdfViewerEnabled", "plugins", "screenResolution", "timezone"], excludeSources, true), sourceKey); });
